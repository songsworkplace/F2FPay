...
namespace WeiXinPaySDK
{
    ...
    {
        public WeixinPayApi(string userIp,string appid,string mch_id,string certPath,string certPassword,string weixinkey,int reportLevenl)
        {
            UserIP = userIp;
            CertPath = certPath;
        ...
        public string WeixinKey { get;private set; }

        public int REPORT_LEVENL { get; private set; }
       ...
       * @param WeixinDataHelper inputObj 提交给查询退款API的参数
       * @param int timeOut 接口超时时间
       * @throws WeixinPayException
       * @return 成功时返回，其他抛异常
       */
        public WeixinDataHelper RefundQuery(WeixinDataHelper inputObj, int timeOut = 6)
        {
            ...
            {
                throw new WeixinPayException("退款查询接口中，out_refund_no、out_trade_no、transaction_id、refund_id四个参数必填一个！");
            }
